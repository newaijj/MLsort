...
delta_large_one = zeros(hidden_layer_size,input_layer_size+1);
...
for t = 1:m
  ...
  delta_large_two = delta_large_two + delta_small_three*a_two(t,:);
endfor;

Theta1_grad = 1/m*delta_large_one + lambda/m*[zeros(size(Theta1,1),1),Theta1(:,2:end)];
Theta2_grad = 1/m*delta_large_two + lambda/m*[zeros(size(Theta2,1),1),Theta2(:,2:end)];
